<?php
//randomly assigns the images to be displayed on the main page. Only 2 images to compare at once.
$qGet = $mysqli->query('
...
while ($dGet = $qGet->fetch_object())
    $rows[] = $dGet;
?>
<!--displays the Image, Name and Updated Score for both the images from the database columns-->
<div class="faces">
...
<p id="middle">OR</p> 
<img src="loader.gif" alt="image loading." width="64" height="64" id="loader" />
